...
- Impareremo i principali **costrutti della programmazione** e la loro applicazione in R
- Impareremo ad essere autonomi con R dalle basi fino ad alcuni aspetti avanzati

---
# Altri obiettivi importanti

- Imparare la .red[logica generale della programmazione] spendibile con qualsiasi linguaggio
- Imparare gli elementi di base per poi stare al passo con la .red[velocissima evoluzione di R]
- Migliorare il modo di affrontare i problemi e .red[rendere più efficiente il lavoro quotidiano]
...
E' nato nel 1993 da .red[Ross Ihaka] e .red[Robert Gentleman] come successore di un'altro linguaggio chiamato **S**.
