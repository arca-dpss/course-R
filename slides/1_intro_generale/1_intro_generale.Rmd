...
- Il materiale del corso (principalmente scripts, slides e link) sarà disponibile alla pagina Github `r icons::fontawesome("github")`: [filippogambarota/corsoR](https://github.com/filippogambarota/corsoR)
