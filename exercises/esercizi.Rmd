...
<!--
TODO: rivedi il primo esercizio
-->
...
7. Aggiungi alla lista nested un vettore numerico selezionando solo i numeri di `x` divisibili per 3
...
3. Definisci una funzione `n_and_media()` che, dato un vettore di valori numerici, calcoli il numero di elementi e la loro media e restituisca entrambe in una frase. Ad esempio `n_and_media(x)` deve restituire "la media di x è ... e la lunghezza di x è ...". Anche qui sono utili le funzioni `paste()` e `print()`.
